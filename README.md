...
## Installation
You can install *Interactions for Student Recruitment* as-is into any Developer Edition, Sandbox, Enterprise, or higher edition org in which HEDA has been installed. The HEDA installer for existing orgs can be found <a href="https://mrbelvedere.salesforcefoundation.org/mpinstaller/hed" target="_blank">here</a>. If you are unfamiliar with HEDA, we recommend learning more about it and its installation and trial org options by reviewing the documentation available <a href="https://powerofus.force.com/articles/Resource/Install-and-Configure-the-Higher-Education-Data-Architecture-HEDA" target="_blank">here</a>. Once HEDA has been installed into an org, you can easily install *Interactions for Student Recruitment* in a sandbox or production/developer org using these unmanaged package links and the <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Installation%20and%20Configuration%20Guide%20-%20Interactions%20for%20Student%20Recruitment.pdf" target="_blank">Installation and Configuration Guide</a>:

* <a href="https://test.salesforce.com/packaging/installPackage.apexp?p0=04t46000000Z330" target="_blank">Install Interactions for Student Recruitment in a Sandbox</a>
* <a href="https://login.salesforce.com/packaging/installPackage.apexp?p0=04t46000000Z330" target="_blank">Install Interactions for Student Recruitment in a Production or Developer Org</a>

Alternatively, please reference the <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Technical%20Implementation%20Guide%20-%20Interactions%20for%20Student%20Recruitment.pdf" target="_blank">Technical Implementation Guide</a> in this repository for non-HEDA orgs.
...
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Overview%20-%20Interactions%20for%20Student%20Recruitment.pdf" target="_blank">Overview of Interactions</a> – This overview document is a high-level look at all the features *Interactions for Student Recruitment* has to offer.
* Interactions Learning Guide (Coming Soon!) – The Learning Guide follows the experience of Stella, the admin, learning about Interactions and how best to implement the package at Connected University (CU). It also follows one of her end users, a recruiter at CU’s School of Business, and their journey to discover how Interactions can help them connect meaningfully with potential students.
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/User%20Guide%20-%20Interactions%20for%20Student%20Recruitment.pdf" target="_blank">User Guide</a> – This guide is both for admins and end users (e.g. recruiters) to learn about best practices for using *Interactions for Student Recruitment* and all its features.
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Installation%20and%20Configuration%20Guide%20-%20Interactions%20for%20Student%20Recruitment.pdf" target="_blank">Installation and Configuration Guide</a> – The Installation and Configuration Guide is an important resource for administrators looking to implement *Interactions for Student Recruitment* with step-by-step instructions for pre-install, install, and post-install requirements and recommendations.
...
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Discovery%20Document%20-%20Interactions%20for%20Student%20Recruitment.pdf" target="_blank">Discovery Document</a> – After all that documentation, it may seem daunting to figure out where to start, but never fear! The Discovery Document is here to streamline your discovery process. Use it to identify current business practices, data models, and integrations that can be managed by *Interactions for Student Recruitment*.
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Interactions%20Discovery%20Document%20Template.xlsx" target="_blank">Interactions Discovery Document Template</a> – This companion to the Discovery Document can be used to organize your findings. The discovery questions are arranged by topic on a spreadsheet along with the purpose behind each question to help you record your requirements.
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Project%20Plan%20and%20Timeline%20-%20Interactions%20for%20Student%20Recruitment.xlsx" target="_blank">Project Plan and Timeline</a> – This template provides a basis for creating your own Project Plan to implement *Interactions for Student Recruitment*.
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Communication%20and%20Training%20Plan%20-%20Interactions%20for%20Student%20Recruitment.xlsx" target="_blank">Communication and Training Plan</a> – As with any major implementation, it is important to have a plan to keep users and stakeholders in the loop and ready for training when the time comes. This template gives you a starting point for building this plan.

### Additional Implementation Resources
* <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Sample%20Data%20-%20Interactions%20for%20Student%20Recruitment.xlsx" target="_blank">Sample Data</a> – This file contains useful sample data that can be loaded into a configured org (with HEDA and *Interactions for Student Recruitment*) to test Interactions and see how the package works with real records.

## Code Example
Below are some samples of the Interaction Processor Class and Interaction Mapping Service Class. See the <a href="https://github.com/SalesforceFoundation/Interactions-for-Student-Recruitment/blob/master/Docs/Technical%20Implementation%20Guide%20-%20Interactions%20for%20Student%20Recruitment.pdf" target="_blank">Technical Implementation Guide</a> for more information about these and the other classes and triggers included in *Interactions for Student Recruitment*.
